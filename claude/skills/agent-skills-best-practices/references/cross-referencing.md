...
- MUST add a new skill to the host project's master skill index, matching its existing structure — in this project, a new row in the `Skill Index` table in `AGENTS.md` with a `When to apply` description.
